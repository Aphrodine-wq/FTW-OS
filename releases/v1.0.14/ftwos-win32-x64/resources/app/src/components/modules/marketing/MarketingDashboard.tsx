      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card>
            ...
            <CardContent className="space-y-4">
                {[
                    { id: 'twitter', name: 'Twitter / X', handle: '@ftw_os', icon: Twitter, color: 'text-sky-500' },
                    { id: 'linkedin', name: 'LinkedIn', handle: 'FTW Systems', icon: Linkedin, color: 'text-blue-700' },
                    { id: 'instagram', name: 'Instagram', handle: '@ftw.life', icon: Instagram, color: 'text-pink-600' },
                    { id: 'facebook', name: 'Facebook', handle: 'FTW Page', icon: Facebook, color: 'text-blue-600' },
                ].map((account) => {
                    const Icon = account.icon
                    return (
                        <div key={account.id} className="flex items-center justify-between p-3 rounded-lg border bg-slate-50/50 hover:bg-slate-100/50 transition-colors">
